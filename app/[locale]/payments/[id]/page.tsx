...
import { ArrowLeft, Calendar, Car, CreditCard, Download, User } from "lucide-react"
import Link from "next/link"
import { Currencies } from "@/types/pricing"
import { PaymentStatus } from "@/types/payment"

export default async function PaymentDetailPage({ params }: Readonly<{ params: Promise<{ id: string }> }>) {
    ...
    return (
        <div className="space-y-6">
            <div className="flex card p-4 flex-col sm:flex-row sm:items-center justify-between gap-4">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="space-y-4">
                                    ...
                                    <div>
                                        ...
                                        {payment.paymentMetadata && payment.paymentMetadata.cardBrand && (
                            ...
                            <div className="space-y-4">
                                <div>
                                    ...
                                    <div className="flex items-center gap-2">
                                        ...
                                        <div>
                                            <Link href={`/users/${payment.booking.user.id}`} className="font-medium hover:underline">

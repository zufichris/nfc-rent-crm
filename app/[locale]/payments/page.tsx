...
function PaymentsPageLoading() {
    return (
        <div className="min-h-screen">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                <StatCard title="Total Payments" subtitle="All Transactions" icon={<CreditCard />} variant="info" value="-" />
                <StatCard title="Paid" subtitle="Completed Payments" icon={<CheckCircle />} variant="success" value="-" />
                <StatCard title="Pending" subtitle="Awaiting Payment" icon={<AlertTriangle />} variant="warning" value="-" />
                <StatCard title="Revenue" subtitle="Total Revenue" icon={<RefreshCcw />} variant="default" value="-" />
            </div>
